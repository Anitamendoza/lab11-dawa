...
import { Tienda } from '../models/tienda'; // Asegúrate de importar el modelo de Tienda

@Injectable({
  providedIn: 'root'
})
export class TiendaService {
  url = 'http://localhost:4000/api/tiendas/'; // Ajusta la URL de la API para las tiendas
